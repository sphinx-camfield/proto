...
const (
	Token_Request_FullMethodName = "/camfield.livekit.token.Token/Request"
)
...
func (c *tokenClient) Request(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RoomTokenReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RoomTokenReply)
	err := c.cc.Invoke(ctx, Token_Request_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTokenServer) Request(context.Context, *Empty) (*RoomTokenReply, error) {
...
func _Token_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TokenServer).Request(ctx, req.(*Empty))
	}
...
var Token_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "camfield.livekit.token.Token",
